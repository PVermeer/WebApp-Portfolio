...
export class UserService {
  ...
  public UserMany(transactions: Array<string>): Observable<any> {
    return this.http.post('/users/many', transactions);
  }
  public deleteUserMany(id: string): Observable<any> {
    return this.http.delete('/users/deletemany/' + id);
  }
  public resetPasswordUserMany(id: string): Observable<any> {
